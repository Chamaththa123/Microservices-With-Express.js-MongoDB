...
const services = [
  { route: '/users', target: 'http://user-service.default.svc.cluster.local:3001', serviceName: 'User Service' },  // Added serviceName
  { route: '/orders', target: 'http://order-service.default.svc.cluster.local:3002', serviceName: 'Order Service' } // Added serviceName
];
